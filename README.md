...
The component palette ships **303 nodes** so the roadmap is visible in the product itself. As of the latest engine cut: **271 available**, **11 preview**, **21 planned**. Each node is tagged by availability:
